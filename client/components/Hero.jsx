      ...
      <div className='w-full h-[500px] bg-[#D9EEE1!important]'>
        <div className='flex justify-center items-center pt-[90px] gap-[40px]'>
          <div>
            ...
            <pre className='text-xl font-semibold font-sans'>     The language for kannadigas</pre>
            <pre>  "code in your regional language"</pre>
          </div>
          <div className="flex justify-center w-[400px]">
            <div className="bg-[#E7E9EB] flex flex-col pl-6 gap-[15px] pb-3 w-[100vh] pr-6 shadow-2xl ">
              ...
              <div className="bg-white font-mono font-semi ">
                <span>
                  <pre>
                    enandre(a&gt;10)&#125;<br /><pre className='inline'>    </pre>macha.helu('hi');<br />&#123;<br />illandre(b&gt;10)&#125;<br /><pre className='inline'>    </pre>macha.helu('hello');<br />&#123;<br />illava &#125;<br /><pre className='inline'>    </pre>macha.helu('error');<br />&#123;     </pre>
                </span>
              </div>
